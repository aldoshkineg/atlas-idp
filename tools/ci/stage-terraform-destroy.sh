...
#   - Incus images (Talos; the Zot image is imported by Terraform via null_resource and is preserved)
...
# 6. Delete Talos image (the Zot image is imported by Terraform via null_resource and is preserved)
